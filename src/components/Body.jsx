    ...
    >
      ...
      <div className="">
          ...
          <div className="flex flex-col md:flex-row justify-evenly  flex-wrap items-stretch m-auto pt-8 w-full">
            <div className="bg-[#FFFFFF] p-3 xl:p-6  text-center items-center md:w-1/2 lg:w-1/4 xl:max-w-[300px] md:m-0  m-5 md:my-0 flex flex-col ">
              <div className="w-full">
                ...
                <img
                  src={get_code}
                  className=" w-full md:h-[180px] h-[225px] sm:h-[275px]"
                  alt="get code"
                />
              </div>
            ...
            <div className="bg-[#FFFFFF]  p-3 xl:p-6 text-center items-center md:w-1/2 lg:w-1/4 md:m-0 xl:max-w-[300px]  m-5 md:my-0 flex flex-col">
              ...
              <div className="text-[17px] text-justify text-[#888888] mt-2 grow">
                ...
                running the panel. */}
                This allows the user to access the panel by navigating to the
                domain in their web browser.
              </div>
              <div className=" mt-2">
                <button className="bg-[#FFFFFF]  hover:bg-[#165461] hover:text-white border-2 border[#588992] p-2 text-[#588992] font-semibold">
                  Learn More
        ...
        <div className="bg-[#FAFAFA] p-3 xl:p-8">
          ...
          <div className="flex flex-col md:flex-row sm:p-0 md:p-8 items-center   m-auto  justify-evenly">
            <div className="card rounded-none flex bg-[#FFFFFF] p-4 md:m-2  md:mt:0 mt-4 md:w-96 w-full  min-h-60vh   my-5 md:my-0">
              ...
              <div className="ml-4 ">
                ...
                <div className="text-[#808080] text-center">
                  ...
                  Enter the name of project and the generated Deployment URL in
                  the “GIT URL” field with port number and click on “Deploy”
                  button.
                </div>
            ...
            <div className="card  rounded-none flex bg-[#FFFFFF] p-4 md:m-2  md:mt:0 mt-4 md:w-96 w-full min-h-60vh   my-5 md:my-0">
              ...
              <div className="ml-4">
                <div className="text-[#5C5C5C] text-center text-[20px]   pb-2 font-bold">
                  {/* Experts validation */}
                ...
                <div className="text-[#808080] text-center">
                  ...
                  Get auto-renewable SSL certificates that enables websites to
                  move from HTTP to HTTPS, which is more secure.Let's Encrypt
                  certificates.
                </div>
                {/* <div className="mt-4 text-center">
                  <button
            ...
            <div className="card rounded-none  flex bg-[#FFFFFF] p-4 md:m-2  md:mt:0 mt-4 md:w-96 w-full  min-h-60vh my-5 md:my-0">
              ...
              <div className="ml-4">
                ...
                <div className="text-[#808080] text-center">
                  ...
                  Find an app that works for you, then launch it in no more than
                  two minutes. Many one-Click Apps accessible like WordPress,
                  LAMP etc.
                </div>
                {/* <div className="mt-4 text-center">
                  <button
            ...
            <div className="card  rounded-none flex bg-[#FFFFFF] p-4 md:m-2  md:mt:0 mt-4 md:w-96 w-full min-h-60vh  my-5 md:my-0">
              ...
              <div className="ml-4">
                ...
                <div className="text-[#808080] text-center">
                  ...
                  Dauqu will do it in such a way that the you will not aware of
                  any downtime taking place while you deploy the new version of
                  the application.
                </div>
                {/* <div className="mt-4 text-center">
                  <button
            ...
            <div className="card rounded-none  flex bg-[#FFFFFF] p-4 md:m-2  md:mt:0 mt-4 md:w-96 w-full min-h-60vh  my-5 md:my-0">
              ...
              <div className="ml-4">
                ...
                <div className="text-[#808080] text-center ">
                  ...
                  Dauqu’s browser-based terminal renders a fully functional
                  console that a user can launch with a single click.
                </div>
                {/* <div className="mt-4 text-center ">
                  <button
                    className="bg-[#FFFFFF] p-2 text-[#6A6A6A] hover:bg-[#165461] hover:text-white"
            ...
            <div className="card  rounded-none flex bg-[#FFFFFF] p-4 md:m-2  md:mt:0 mt-4 md:w-96 w-full min-h-60vh  my-5 md:my-0">
              ...
              <div className="ml-4">
                ...
                <div className="text-[#808080] text-center ">
                  ...
                  With Docker, it is easy to package your code into an image
                  that we can run anywhere, anytime.
                </div>
                {/* <div className="mt-4 text-center ">
                  <button
                    className="bg-[#FFFFFF] p-2 text-[#6A6A6A] hover:bg-[#165461] hover:text-white"
        ...
        <div className="bg-[#FAFAFA] p-8  " id="plans">
          ...
          <div
            id="element"
            className="w-[70%] m-auto text-center md:text-[40px] text-[#333333] mt-8 font-bold"
          >
